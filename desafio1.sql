...
INSERT INTO SpotifyClone.cancoes (cancoes, album_id, duracao_segundos, ano_lancamento, artista_id)
	VALUES
		('BREAK MY SOUL', 1, 279, 2022, 1),
        ('VIRGO’S GROOVE', 1, 369, 2022, 1),
        ('ALIEN SUPERSTAR', 1, 116, 2022, 1),
        ('Don’t Stop Me Now', 2, 203, 1978, 2),
        ('Under Pressure', 3, 152, 1982, 2),
        ('Como Nossos Pais', 4, 105, 1998, 3),
        ('O Medo de Amar é o Medo de Ser Livre', 5, 207, 2001, 3),
        ('Samba em Paris', 6, 267, 2003, 4),
        ('The Bard’s Song', 7, 244, 2007, 5),
        ('Feeling Good', 8, 100, 2012, 6);
